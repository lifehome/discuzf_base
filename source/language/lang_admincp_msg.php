...
$lang = array (
  ...
  'members_sms_illegal' => '手機號碼無效',
  'members_sms_duplicate' => '該手機號碼已經被註冊',
  'members_loginname_is_numeric' => '抱歉，登錄名不能是純數字',
  'members_loginname_tooshort' => '抱歉，您輸入的登錄名小於 3 個字符，請輸入一個較長的登錄名',
  'members_loginname_exists' => '抱歉，您輸入的登錄名重複，請更換',
  ...
  'pack_not_found' => '未安裝過擴展程序，或擴展程序已全部卸載',
  'packs_identifier_invalid' => '擴展標識符不合法',
  'packs_validator_noupdate' => '沒有檢測到新版本擴展',
  'packs_delete_invalid' => '該擴展包含系統文件，為避免系統功能異常，不允許直接卸載，請聯繫 {pack} 的作者處理',

  'plugin_not_found' => '插件未找到',
  'plugin_setting_not_found' => '此插件沒有設置項目',
  ...
  'plugins_delete_failure' => '插件卸載失敗！是否繼續卸載？',
  ...
  'upgrade_downloading_file' => '正在下載更新文件 {file} <br>已完成{percent} {upgradeurl}',
  ...
  'upgrade_successful' => '恭喜您，升級成功! <br />您當前的版本為：Discuz! F{version} Release[{release}] <br /><br />為安全起見，升級文件已保存至{save_update_dir}目錄，<br />備份文件已保存至{save_back_dir}目錄 {upgradeurl}',
