...
$lang = array (
  ...
  'sms_credit_inadequate' => '抱歉，您沒有足夠的積分來完成此次邀請',
  'send_result_succeed' => '邀請已送出，您的好友可能需要幾分鐘後才能收到邀請信息',
  'send_result_resend_error' => '抱歉，尚未找到相應的邀請記錄, 邀請重發失敗',
  ...
  'profile_sms_illegal' => '手機號碼無效',
  'profile_sms_duplicate' => '該手機號碼已被註冊',
  ...
  'no_privilege_sms' => '抱歉，您需要驗證激活自己的手機後才能進行本操作，<a href="home.php?mod=spacecp&ac=profile&op=password">點擊這裡激活手機</a>',
  ...
  'register_sms_send_fail' => '短信驗證碼發送失敗',
  'register_sms_send_success' => '短信驗證碼發送成功',
  'register_sms_check_fail' => '短信驗證碼校驗失敗',
  ...
  'profile_loginname_is_numeric' => '抱歉，登錄名不能是純數字',
  'profile_loginname_tooshort' => '抱歉，您輸入的登錄名小於 3 個字符，請輸入一個較長的登錄名',
  'profile_loginname_exists' => '抱歉，您輸入的登錄名重複，請更換',
  'profile_smscode_notmatch' => '抱歉，手機短信驗證碼不正確',
  ...
  'sms_verify_invalid' => '抱歉，您在 24 小時內只能提交一次驗證手機號碼請求',
  'sms_verify_succeed' => '驗證短信已發送，請將收到的驗證碼填寫到頁面的文本框內',
  ...
  'lostpasswd_sms_not_exist' => '抱歉，使用此手機號碼的用戶不存在，不能使用取回密碼功能',
  'lostpasswd_emall_sms_all_not_exist' => '抱歉，Email 和手機號至少要填寫一項才能使用取回密碼功能',
  'lostpasswd_many_users_use_email' => '抱歉，存在多個使用此 Email 的用戶，請填寫您需要找回密碼的用戶名',
  'lostpasswd_many_users_use_sms' => '抱歉，存在多個使用此手機號碼的用戶，請填寫您需要找回密碼的用戶名',
  ...
  'getpasswd_send_newpass' => '您的新密碼已通過短信發送到您的手機中，<br />請立即登錄並修改您的密碼',

  'submit_verify_succeed' => '審核請求提交成功，現在將返回個人中心',

  'buyinvitecode_no_count' => '未填寫購買邀請碼數量，請返回',
  'buyinvitecode_email_error' => '郵件地址未填或格式錯誤',
  'buyinvitecode_sms_error' => '手機號碼未填或格式錯誤',
  'buyinvitecode_input_empty' => '郵件地址和手機號碼至少填寫其中一項',
  ...
  'sms_check_sucess' => '您的手機號({email})驗證激活成功 ',
  'sms_check_account_invalid' => '抱歉，受保護用戶或創始人不能使用短信驗證，直接修改用戶信息。',
  'sms_check_error' => '抱歉，您輸入的驗證碼不正確。您可以在個人資料頁面，重新接收新的短信驗證碼',
  ...
  'sms_invite_not_allow' => '抱歉，您沒有權限使用短信邀請',
  'sms_can_not_be_empty' => '抱歉，短信列表不能為空',
  ...
  'profile_passwd_wrong' => '原密碼不正確，您不能修改密碼或Email、手機號或安全提問',
  'profile_email_verify' => '確認 Email 已發送，請用郵件中提供的方法激活您的帳號。如果您尚未收到我們發送的系統郵件，請點擊密碼安全中的「重新接收驗證郵件」，或嘗試更換另外一個地址',
  'profile_sms_verify' => '驗證碼已發送，請將收到的驗證碼填寫到當前頁面激活您的帳號。如果您尚未收到我們發送的系統短信，請點擊密碼安全中的「重新接收驗證短信」，或嘗試更換另外一個號碼',
  ...
  'send_activate_sms_succeed' => '短信已發送，可能需要幾分鐘後才能收到短信',
  'send_activate_sms_error' => '抱歉，短信發送失敗，請過5分鐘後重試發送驗證短信',
  ...
  'no_privilege_sendsmsday' => '抱歉，本站尚未開啟短信提醒功能',
  'sms_input' => '抱歉，您尚未設置手機，請在<a href="home.php?mod=spacecp&ac=profile&op=password">聯繫方式</a>中準確填寫您的手機',
  ...
  'location_login_force_sms' => '您所在的用戶組必須使用手機登錄',
  ...
  'register_sms_send_succeed' => '感謝您註冊 {bbname}，<br />系統給您發送了一封帶有註冊地址的短信，快去查看手機獲取註冊鏈接進行下一步註冊吧',
  ...
  'register_sms_verify' => '感謝您註冊 {bbname}，<br />快去驗證手機激活賬號吧',
  'register_sms_verify_location' => '<a href="home.php?mod=spacecp&ac=profile&op=password">獲取驗證短信</a> <a href="home.php?mod=space&do=home">先去逛逛</a>',
